...
interface WebSocketShardEventsMap {
    ...
    [WebSocketShardEvents.HeartbeatComplete]: [stats: {
        ackAt: number;
        heartbeatAt: number;
        latency: number;
    }];
...
declare class WebSocketShard extends AsyncEventEmitter<WebSocketShardEventsMap> {
    ...
    readonly id: number;
    private identifyCompressionEnabled;
    /**
     * @privateRemarks
     *
...
declare const DefaultWebSocketManagerOptions: {
    ...
    readonly useIdentifyCompression: false;
...
declare class WebSocketManager extends AsyncEventEmitter<ManagerShardEventsMap> implements AsyncDisposable {
     ...
     */
    readonly options: Omit<WebSocketManagerOptions, 'token'>;
    /**
...
interface FetchingStrategyOptions extends Pick<WebSocketManagerOptions, 'compression' | 'encoding' | 'handshakeTimeout' | 'helloTimeout' | 'identifyProperties' | 'initialPresence' | 'intents' | 'largeThreshold' | 'readyTimeout' | 'token' | 'useIdentifyCompression' | 'version'> {
