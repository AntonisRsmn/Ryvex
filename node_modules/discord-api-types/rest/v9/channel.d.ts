...
import type { APIAllowedMentions, APIChannel, APIEmbed, APIExtendedInvite, APIFollowedChannel, APIMessage, APIMessageReference, APIMessageSharedClientTheme, APIThreadList, APIThreadMember, APIUser, ChannelType, InviteTargetType, MessageFlags, OverwriteType, ThreadAutoArchiveDuration, ThreadChannelType, VideoQualityMode, APIGuildForumTag, APIGuildForumDefaultReactionEmoji, SortOrderType, ForumLayoutType, ChannelFlags, APIAttachment, APIMessageTopLevelComponent, APIMessagePin, APIAnnouncementThreadChannel, APIPrivateThreadChannel, APIPublicThreadChannel } from '../../payloads/v9/index';
...
export interface RESTPostAPIChannelMessageJSONBody {
     ...
     *
     * @see {@link https://discord.com/developers/docs/resources/channel#embed-object}
     * @deprecated Use {@link RESTPostAPIChannelMessageJSONBody.embeds} instead
     */
...
export interface RESTPatchAPIChannelMessageJSONBody {
     ...
     *
     * @see {@link https://discord.com/developers/docs/resources/channel#embed-object}
     * @deprecated Use {@link RESTPatchAPIChannelMessageJSONBody.embeds} instead
     */
...
/**
 * @see {@link https://discord.com/developers/docs/resources/channel#list-active-threads}
 * @deprecated Removed in API v10, use {@link https://discord.com/developers/docs/resources/guild#list-active-guild-threads | List Active Guild Threads} instead.
 */
